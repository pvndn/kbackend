...
<!--[if gt IE 8]><!--> <html class="no-js" lang=""> <!--<![endif]-->
    ...
    <body id="minovate" class="appWrapper">
        ...
        <script src="/assets/admin/js/vendor/d3/d3.min.js"></script>
        <script src="/assets/admin/js/vendor/d3/d3.layout.min.js"></script>

        <script src="/assets/admin/js/vendor/rickshaw/rickshaw.min.js"></script>
        ...
        <script src="/assets/admin/js/vendor/flot/jquery.flot.min.js"></script>
        <script src="/assets/admin/js/vendor/flot-tooltip/jquery.flot.tooltip.min.js"></script>
        <script src="/assets/admin/js/vendor/flot-spline/jquery.flot.spline.min.js"></script>
